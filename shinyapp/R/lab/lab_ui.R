...
lab_ui <- function(id){
  ...
  tagList(
    ...
    tags$ul(
      tags$li("it allows different architecture / implementations"),
    ...
    p("For the sake of the example, a very basic data model is defined in this example: date, name, value, checked.", br(),
      "This was done through the admin console (see data model tab)."),
    
    p("Visit the", a(href = "https://thekangaroofactory.github.io/kitems/", target = "_blank", "website"), "to get more details."),
    ...
    navset_card_pill(
      ...
      nav_panel("Items", 
                ...
                layout_columns(
                  ...
                  card(
                    ...
                    p("From there, you can use the", tags$code("data"), "object to build for example plots."),
                    
                    p("Server-to-server communication may be used to programmatically create (update / delete) items:"),
                    div(
                      style = "display:inline-block;",
      ...
      nav_panel("Data model",
                ...
                p(class = "mt-2", "The data model documents the structure of an item.", br(),
